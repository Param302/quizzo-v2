...
class PublicProfileResource(Resource):
    def get(self, username):
        ...
        total_marks_obtained = sum(score['score']['obtained_marks'] for score in quiz_scores)
        total_marks_possible = sum(score['score']['total_marks'] for score in quiz_scores)
...
def register_public_routes(api):
