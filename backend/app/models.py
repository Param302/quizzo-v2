...
class Chapter(db.Model):
    ...
    subscriptions = db.relationship("Subscription", backref="chapter", lazy=True, cascade="all,delete")
...
class Quiz(db.Model):
    ...
    date_of_quiz = db.Column(db.DateTime, nullable=True)  # Nullable if open quiz
    ...
    submissions = db.relationship("Submission", backref="quiz", lazy=True, cascade="all,delete")
...
class Question(db.Model):
    ...
    options = db.Column(JSON, nullable=True)  # List of options for MCQ/MSQ, null for NAT
    correct_answer = db.Column(JSON, nullable=False)  # For MCQ: [index], MSQ: [indices], NAT: [value or range]
...
class Submission(db.Model):
    ...
    answer = db.Column(JSON, nullable=False)  # Matches format of correct_answer
...
class Subscription(db.Model):
    ...
    is_active = db.Column(db.Boolean, default=True)  # Active or inactive subscription